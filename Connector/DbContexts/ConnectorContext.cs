...
namespace Connector.DbContexts;
...
public partial class ConnectorContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Header>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNavigation).WithOne(p => p.Header)
                .HasForeignKey<Header>(d => d.Id)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Header_ApiDetails");
        ...
        modelBuilder.Entity<QueryParameter>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNavigation).WithOne(p => p.QueryParameter)
                .HasForeignKey<QueryParameter>(d => d.Id)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_QueryParameters_ApiDetails");
